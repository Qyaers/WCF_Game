...
namespace ChatClient.ServiceChat {
    ...
    public interface IServiceChat {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/SendStartGame")]
        void SendStartGame(string msg, int id);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/SendStartGame")]
        System.Threading.Tasks.Task SendStartGameAsync(string msg, int id);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/ResultGame")]
        void ResultGame(string msg, int id);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/ResultGame")]
        System.Threading.Tasks.Task ResultGameAsync(string msg, int id);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/SendTimer")]
        void SendTimer(int timer);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/SendTimer")]
        System.Threading.Tasks.Task SendTimerAsync(int timer);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/PickingWinner")]
        void PickingWinner();
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/PickingWinner")]
        System.Threading.Tasks.Task PickingWinnerAsync();
    }
    ...
    public interface IServiceChatCallback {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/GameCallBack")]
        void GameCallBack(string msg);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/ResultOfGameCallbak")]
        void ResultOfGameCallbak(string msg);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/TimerCallback")]
        void TimerCallback(string msg, int timer);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/PickingWinnerCallback")]
    ...
    public partial class ServiceChatClient : System.ServiceModel.DuplexClientBase<ChatClient.ServiceChat.IServiceChat>, ChatClient.ServiceChat.IServiceChat {
        ...
        public void SendStartGame(string msg, int id) {
            base.Channel.SendStartGame(msg, id);
        }
        
        public System.Threading.Tasks.Task SendStartGameAsync(string msg, int id) {
            return base.Channel.SendStartGameAsync(msg, id);
        }
        
        public void ResultGame(string msg, int id) {
            base.Channel.ResultGame(msg, id);
        }
        
        public System.Threading.Tasks.Task ResultGameAsync(string msg, int id) {
            return base.Channel.ResultGameAsync(msg, id);
        }
        
        public void SendTimer(int timer) {
            base.Channel.SendTimer(timer);
        }
        
        public System.Threading.Tasks.Task SendTimerAsync(int timer) {
            return base.Channel.SendTimerAsync(timer);
        }
        
        public void PickingWinner() {
            base.Channel.PickingWinner();
        }
        
        public System.Threading.Tasks.Task PickingWinnerAsync() {
            return base.Channel.PickingWinnerAsync();
        }
    }
}
